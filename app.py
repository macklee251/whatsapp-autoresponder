...
# ========= IA =========
# (no seu ai_provider.py já existe generate_reply com pool/fallback)
...
ALERT_EMAIL = os.getenv("ALERT_EMAIL")  # e-mail que receberá alertas “quero marcar”
...
def send_text(to_number_e164: str, text: str) -> bool:
    ...
    try:
        ...
        if r.ok and (body.get("sent") is True or body.get("message") in ("Message has been sent", "ok")):
            if body.get("id"):
